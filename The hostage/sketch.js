...
function preload(){
  doctor_img=loadImage("Images/run1.png");
  vaccine_img=loadImage("Images/hostage.png");
  corona_img=loadImage("Images/terrorist.png");
...
function setup() {
  ...
  doctor=createSprite(45,30,15,15);
...
//doctor.debug=true;
doctor.setCollider("rectangle",0,0,100,100);
...
vaccine.scale=0.1;
//vaccine.debug=true;
vaccine.setCollider("circle",0,50,200);
